				...
				if (tempMap.containsKey(tempPos)) {
					...
					while (it.hasNext()) {
						...
						case ("Dispenser"):
							...
							if ((!blockLayer.containsKey(absolutePos)) || (!(blockLayer.get(absolutePos) == null)
									&& blockLayer.get(absolutePos).getLastSeen() < currentStep)) {
								blockLayer.put(absolutePos, null);
							}
							if ((!goalzoneLayer.containsKey(absolutePos)) || (!(goalzoneLayer.get(absolutePos) == null)
									&& goalzoneLayer.get(absolutePos).getLastSeen() < currentStep)) {
								goalzoneLayer.put(absolutePos, null);
							}
							if ((!rolezoneLayer.containsKey(absolutePos)) || (!(rolezoneLayer.get(absolutePos) == null)
									&& rolezoneLayer.get(absolutePos).getLastSeen() < currentStep)) {
								rolezoneLayer.put(absolutePos, null);
							}
<<<<<<< Updated upstream
=======
							if ((!entityLayer.containsKey(absolutePos)) || (!(entityLayer.get(absolutePos) == null)
									&& entityLayer.get(absolutePos).getLastSeen() < currentStep)) {
...
>>>>>>> Stashed changes
						...
						case ("Rolezone"):
							...
							if ((!obstacleLayer.containsKey(absolutePos)) || (!(obstacleLayer.get(absolutePos) == null)
									&& obstacleLayer.get(absolutePos).getLastSeen() < currentStep)) {
								obstacleLayer.put(absolutePos, null);
							}
							if ((!blockLayer.containsKey(absolutePos)) || (!(blockLayer.get(absolutePos) == null)
									&& blockLayer.get(absolutePos).getLastSeen() < currentStep)) {
							...
							if ((!dispenserLayer.containsKey(absolutePos))
									|| (!(dispenserLayer.get(absolutePos) == null)
											&& dispenserLayer.get(absolutePos).getLastSeen() < currentStep)) {
...
=======
		...
		// For testing
		/*
		 * System.out.println("Current Position:"); System.out.println(currentPosition);
		 * System.out.println("Goal Zone Layer:"); System.out.println(goalzoneLayer);
		 * System.out.println("Role Zone Layer:"); System.out.println(rolezoneLayer);
		 * System.out.println("Dispenser Layer:"); System.out.println(dispenserLayer);
		 * System.out.println("Block Layer:"); System.out.println(blockLayer);
		 * System.out.println("Obstacle Layer:"); System.out.println(obstacleLayer);
		 * System.out.println("Entity Layer:"); System.out.println(entityLayer);
		 * System.out.println("Known Area:"); System.out.println(knownArea);
		 */
>>>>>>> Stashed changes
	}
...
>>>>>>> Stashed changes
	...
	public void mergeMaps(HashMap<RelativeCoordinate, Block> sentBlocks,
			...
			RelativeCoordinate sentPosition, int stepOfSentMap) {
		...
		for (RelativeCoordinate key : sentBlocks.keySet()) {
			...
			if (!blockLayer.containsKey(newKey)
					|| blockLayer.get(newKey).getLastSeen() < sentBlocks.get(key).getLastSeen()) {
		...
		for (RelativeCoordinate key : sentDispensers.keySet()) {
			...
			if (!dispenserLayer.containsKey(newKey)
					|| dispenserLayer.get(newKey).getLastSeen() < sentDispensers.get(key).getLastSeen()) {
		...
		for (RelativeCoordinate key : sentGoalzones.keySet()) {
			...
			if (!goalzoneLayer.containsKey(newKey)
					|| goalzoneLayer.get(newKey).getLastSeen() < sentGoalzones.get(key).getLastSeen()) {
		...
		for (RelativeCoordinate key : sentRolezones.keySet()) {
			...
			if (!rolezoneLayer.containsKey(newKey)
					|| rolezoneLayer.get(newKey).getLastSeen() < sentRolezones.get(key).getLastSeen()) {
		...
		for (RelativeCoordinate key : sentObstacles.keySet()) {
			...
			if (!obstacleLayer.containsKey(newKey)
					|| obstacleLayer.get(newKey).getLastSeen() < sentObstacles.get(key).getLastSeen()) {
